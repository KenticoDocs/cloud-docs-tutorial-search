...
const TRAINING_COURSE_CONTENT_TYPE = 'training_course';

const ROOT_CONTENT_TYPES = ['article', 'scenario', TERM_DEFINITION_CONTENT_TYPE, RELEASE_NOTE_CONTENT_TYPE, TRAINING_COURSE_CONTENT_TYPE];
